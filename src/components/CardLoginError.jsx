import { Field, Center, Box, Input, Text, Button, Stack } from "@chakra-ui/react"

export const CardLoginError = () => {
...
<Box h='100vh'>
        ...
        <Center>
                <Box bg='black' color='white' w={{md:'30vw', base:'80vw'}} padding='25px'>
